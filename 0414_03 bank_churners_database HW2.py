"""
HW: 將csv檔讀進來,可透過 新增,修改,刪除,儲存 產生新的csv檔
    並呼叫0413_04 bank_churners_graph_analytics.py檔,產生圖表
Date:2022/04/14
Data: 'BankChurners-editable.csv'
      'BankChurners.csv'
      '0413_04 bank_churners_graph_analytics.py'
"""
"""
資料說明：
...
file_name = 'BankChurners-editable.csv'
...
import subprocess
def showPlots():
    t=subprocess.run(["python", "0413_04 bank_churners_graph_analytics.py"]) # 呼叫另一個py檔
